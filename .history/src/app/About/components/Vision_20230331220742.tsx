        ...
        <>
            <section className=" py-10 ">
                ...
                <div className="vision flex flex-col  space-y-5 justify-center items-center ">
                    ...
                    <div className='divider h-2 w-[100px] bg-[#9024ce] '></div>
                </div>
                {/* Mission  */}
                {/* Core Values */}
                {/* Core Values */}
