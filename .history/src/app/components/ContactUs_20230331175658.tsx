            ...
            <section className=" bg-[url('/assets/map_black.jpeg')] bg-cover bg-no-repeat bg-top px-5 py-10 h-[500px] ">
                ...
                <form action="" className=' flex flex-col md:flex-row'>
                    <div className='  md:w-[90%] md:mx-auto md:flex md:flex-col md:items-center'>
                        ...
                        <button type='submit' className='self-center md:w-fit rounded-md bg-red-600 hover:bg-red/60  px-4 py-3 w-full mt-4 mb-5 md:text-white lg:px='>SEND MESSAGE</button>
                    </div>
                </form>
