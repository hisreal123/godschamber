            ...
            <section className='bg-gray-800 text-white/70 py-10 px-5 '>
                <div className='md:w-[80%] md:mx-auto'>
                    ...
                    <footer className='media w-full relative '>
                        <div className="links">
                            <Link href="/" className='bg-white block  w-fit '>{fbColor}</Link>
                            <Link href="/" className='bg-white block  w-fit '>{twitterColor}</Link>
                            <Link href="/" className='bg-white block  w-fit '>{igColor}</Link>
                            <Link href="/" className='bg-white block  w-fit '>{ytColor}</Link>
                        </div>
                    </footer>
