                    ...
                    <div className=' bg-red-200 md:w-[90%] md:mx-auto '>
                        <div className=" md:flex w-full ">
                            <div className="flex flex-col justify-center space-y-5">
                                <input type="text" placeholder='YOUR NAME *' className='text-sm rounded-3xl px-4 py-1 hover:first-letter:border-red-300 border-2 outline-none md:text-md lg:text-lg md:' />
