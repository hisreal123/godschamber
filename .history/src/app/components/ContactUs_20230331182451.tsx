                ...
                <section className=" bg-[url('/assets/map_black.jpeg')] bg-cover bg-no-repeat bg-top px-5 py-10 h-auto">
                    ...
                    <form action="" className=' flex flex-col md:flex-row'>
                        <div className='  md:w-[90%] md:mx-auto md:flex md:flex-col md:items-center'>
                            <div className=" md:grid md:grid-cols-2 md:gap-5 relative  w-[80%]">
                            ...
                            <button type='submit' className='self-center md:w-fit rounded-md bg-red-600 hover:bg-red/60  px-4 py-3 w-full mt-4 md:mt-10 mb-5 md:text-white lg:px-10 hover:bg-red-800 md:font-light '>SEND MESSAGE</button>
                        </div>
                    </form>
