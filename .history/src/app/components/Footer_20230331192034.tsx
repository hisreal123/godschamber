        ...
        <>
            <section className='bg-gray-800 text-white/70 py-10 px-5'>
                <footer className="top">
                    <div className="links">
                        <div className='flex flex-col space-y-3 mb-10 md:'>
                        ...
                        <div className='flex flex-col space-y-3 mb-10 md:'>
                            <h2 className='text-2xl font-bold mb-5'>Connect</h2>
                        ...
                        <div className='flex flex-col space-y-3 mb-10 md:'>
                            <h2 className='text-2xl font-bold mb-5'>Watch</h2>
                        ...
                        <div className='flex flex-col space-y-3 mb-10 md:'>
                            <h2 className='text-2xl font-bold mb-5'>Care</h2>
