                        ...
                        <div className='  md:w-[90%] md:mx-auto md:flex md:flex-col md:items-center'>
                            <div className=" md:grid md:grid-cols-2 md:gap-5 relative w-full md:w-[80%]">
                                <div className="flex  md:flex-1 flex-col justify-center space-y-5 relative">
                                    <input type="text" placeholder='YOUR NAME *' className='text-sm rounded-3xl px-4 py-4 hover:first-letter:border-red-300 border-2 outline-none  md:w-full' />
                                    <input type="email" placeholder=' YOUR EMAIL *' className='text-sm rounded-3xl px-4 py-4 hover:first-letter:border-red-300 border-2 outline-none' />
                                    <input type="text" placeholder=' SUBJECT*' className='text-sm rounded-3xl px-4 py-4 hover:first-letter:border-red-300 border-2 outline-none ' />
                                </div>
