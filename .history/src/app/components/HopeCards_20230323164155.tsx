  ...
  return (
    <>
      <div className="wrapper px-5 relative z-0">
        ...
        <div className="CardWrapper grid grid-cols-1 w-screen ">
          <Cards imgSrc="/assets/img1.jpg" text="Get Inspired:Message Series" alt=" Get inspired" mainStyle="flex flex-col bg-red-200 overflow-hidden h-40 w-full " topStyle='' btmStyle='' textStyle='' />
