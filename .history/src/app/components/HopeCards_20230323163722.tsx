    ...
    <>
      <div className="wrapper px-5 relative z-0">
        ...
        <div className="CardWrapper">
          <Cards imgSrc="/assets/img1.jpg" text="Get Inspired:Message Series" alt=" Get inspired" mainStyle="flex flex-col bg-red-200 " topStyle='w-screeb' btmStyle='' textStyle='' />
