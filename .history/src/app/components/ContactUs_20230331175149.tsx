        ...
        <>
            <section className=" bg-[url('/assets/map_black.jpeg')] bg-cover bg-no-repeat bg-top px-5 py-10 h-[500px] ">
                ...
                <form action="" className=' flex flex-col md:flex-row'>
                    <div className=' bg-red-200 md:w-[90%] md:mx-auto '>
                        <div className=" md:flex md:space-x-5 w-full relative ">
                            <div className="flex md:w-[90%] flex-col justify-center space-y-5 relative">
                                <input type="text" placeholder='YOUR NAME *' className='text-sm rounded-3xl px-4 py-1 hover:first-letter:border-red-300 border-2 outline-none md:text-md lg:text-lg md:w-full' />
