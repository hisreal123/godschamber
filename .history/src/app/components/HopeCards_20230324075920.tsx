    ...
    <>
      <div className="wrapper px-5 relative z-0">
        ...
        <div className="CardWrapper grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 ">
          <Cards imgSrc="/assets/img1.jpg" text="Get Inspired:Message Series" alt=" Get inspired" mainStyle="flex flex-col bg-red-300 overflow-hidden  w-full " topStyle='' btmStyle=' py-4 ' textStyle='' />
