            ...
            <section className=" bg-[url('/assets/map_black.jpeg')] bg-cover bg-no-repeat bg-top px-5 py-10 h-[500px] ">
                ...
                <div className=' flex flex-col items-center md:flex-row relative'>
                    <form action="" method="post">
                        ...
                        <textarea placeholder='YOUR MESSAGE' className='text-sm rounded-xl px-4 py-3 hover:first-letter:border-red-300 border-2 outline-none mt-5 md:mt-0 md:text-md lg:text-lg mx-auto ' rows={4} />

                        <button type='submit' className='rounded-md  bg-red-600 hover:bg-red/60  px-4 py-3 w-full mt-4'>SEND MESSAGE </button>
                    </form>
                </div>
            </section>
        </>
