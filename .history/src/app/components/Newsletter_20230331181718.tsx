        ...
        <>
            <section className='py-16 px-5'>
                <div className='flex flex-col items-center justify-center relative '>
                    ...
                    <form method="post">
                        <input type="email" placeholder=' YOUR EMAIL *' className='w-full lg:mb-5  text-sm rounded-3xl px-4 py-2 hover:first-letter:border-red-300 border-2 outline-none' />
