...
export default function ContactUs() {
    return (
        <>
            <section className=" bg-[url('/assets/map_black.jpeg')] bg-cover bg-no-repeat bg-top px-5 py-10h-[500px] ">
                <h1 className='text-center my-10 text-white font-bold  text-lg'>CONTACT US </h1>
