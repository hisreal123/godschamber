            ...
            <section className='bg-gray-800 text-white/70 py-10 px-5 '>
                <div className='md:w-[80%] md:mx-auto'>
                    ...
                    <footer className='media w-full relative '>
                        <div className="links">
                            <Link href="/" className='bg-whit'>{fbColor}</Link>
                            <Link href="/" className='bg-whit'>{twitterColor}</Link>
                            <Link href="/" className='bg-whit'>{igColor}</Link>
                            <Link href="/" className='bg-whit'>{ytColor}</Link>
                        </div>
                    </footer>
