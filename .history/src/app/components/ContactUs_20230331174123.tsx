            ...
            <section className=" bg-[url('/assets/map_black.jpeg')] bg-cover bg-no-repeat bg-top px-5 py-10 h-[500px] ">
                ...
                <form action="" className=' flex flex-col '>
                    <div className="flex flex-col justify-center ">
                        ...
                        <input type="email" placeholder=' YOUR EMAIL *' className='text-sm rounded-3xl px-4 py-2 hover:first-letter:border-red-300 border-2 outline-none md:text-md lg:text-lg' />
