...
export default function Sidebar() {
  ...
  return (
    ...
    <div className={ Open ? " h-screen bg-slate-400 w-4/5 absolute top-0  right-0 shadow-lg z-100" : 'hidden '}>      
        <SideBarNav toggleSideBar={toggleSideBar} style='relative h-screen bg-green-200 w-full pt-20' liStyle=' inline-block  p-2  mt-1 text-xs w-full font-lighter opcai-  '/>
    </div>
