                ...
                <div className="px-5">
                    {
                        MoreSection2Data.map((data, index) => (
                            <>
                                <div className=" bg-red-300 wrap grid grid-cols-1 grid-gap-3 md:grid-cols-4 lg:grid-cols-4">
                                    <CardsComponents
                                        imgSrc={data.imgSrc}
                                        text={data.title}
                                        desc={data.desc}
                                        ...
                                        topStyle=' h-60 w-60 md:h-50 w-50 rounded-full overflow-hidden shadow-xl'
