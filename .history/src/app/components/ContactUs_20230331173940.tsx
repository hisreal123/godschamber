        ...
        <>
            <section className=" bg-[url('/assets/map_black.jpeg')] bg-cover bg-no-repeat bg-top px-5 py-10 h-[500px] ">
                ...
                <form action="" className=' bg-red-200 flex flex-col '>
                    <div className=" ">
                        <input type="text" placeholder='YOUR NAME *' className='text-sm rounded px-4 py-3 hover:first-letter:border-red-300 border-2 outline-none md:text-md lg:text-lg' />
