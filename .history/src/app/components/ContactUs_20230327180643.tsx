            ...
            <section className=" bg-[url('/assets/map_black.jpeg')] bg-cover bg-no-repeat bg-top px-5 h-[500px] ">
                ...
                <div className=' flex flex-col items-center md:flex-row'>
                    <form action="" method="post">
                        ...
                        <textarea placeholder=' YOUR MESSAGE' className='text-sm rounded-xl px-4 py-3 hover:first-letter:border-red-300 border-2 outline-none md:text-md lg:text-lg' rows={4} />
                    </form>
                </div>
            </section>
        </>
