...
export default function Sidebar() {
  ...
  return (
    ...
    <div className={ Open ? " h-screen bg-slate-400 w-4/5 absolute top-0  right-0 shadow-lg z-100" : 'hidden '}>
      ...
      <div className=" relative bg-red-200 h-screen flex pt-20 ">
        <SideBarNav toggleSideBar={toggleSideBar} style='bg-green-200 w-full h-ful relative' liStyle='text-xs py-4 my-10 bg-red-300 '/>
      </div>
    </div>
