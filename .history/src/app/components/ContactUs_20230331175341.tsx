                    ...
                    <div className='  md:w-[90%] md:mx-auto '>
                        <div className=" md:flex md:w-[80%] md:mx-auto md:space-x-5 w-full relative ">
                            <div className="flex  flex-col justify-center space-y-5 relative">
                                <input type="text" placeholder='YOUR NAME *' className='text-sm rounded-3xl px-4 py-1 hover:first-letter:border-red-300 border-2 outline-none  md:w-full' />
                                <input type="email" placeholder=' YOUR EMAIL *' className='text-sm rounded-3xl px-4 py-1 hover:first-letter:border-red-300 border-2 outline-none' />
                                <input type="text" placeholder=' SUBJECT*' className='text-sm rounded-3xl px-4 py-1 hover:first-letter:border-red-300 border-2 outline-none ' />
                            </div>
