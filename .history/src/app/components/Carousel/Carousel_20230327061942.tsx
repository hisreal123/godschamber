...
export default function Carousel() {
    ...
    return (
        <>
            <section className=' pb-20 bg-red-200'>
                <div className="imgWrapper  h-[300px] relative md:w-[600px] md:m-auto  bg-red-200">
                    <span className=' text-xl cursor-pointer absolute z-30 top-0 bottom-0 bg-white/90 rounded-full ml-2' onClick={swipleft}>{left}</span>
