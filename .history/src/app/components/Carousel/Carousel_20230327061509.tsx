    ...
    return (
        <>
            <section>
                ...
                <div className="imgWrapper  h-[300px] relative md:w-[500px] md:m-auto">

                    <span className='rounded-md text-xl cursor-pointer absolute z-30 top-[50%] bg-white/90 rounded-full ml-2' onClick={swipleft}>{left}</span>
