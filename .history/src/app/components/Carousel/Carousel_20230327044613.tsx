        ...
        <>
            <section>
                ...
                <div className="imgWrapper  h-[300px] relative ">
                    ...
                    <span className='text-xl cursor-pointer absolute z-30 top-[50%]' onClick={swipleft}>{left}</span>

                    <div className='relative imgWrapper bg-red-300 h-full py-5 bg-white'>
