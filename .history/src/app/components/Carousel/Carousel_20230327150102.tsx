...
export default function Carousel() {
            ...
            <section className=' overflow-hidden mb-10' >
                <div className=" h-[400px] md:w-[600px] mx-auto  imgWrapper  relative min:h-full  md:m-auto rounded-lg  bg-red-200">
                    <div className='relative h-full rounded-lg overflow-hidden'>
                        ...
                        <undefined   swipleft={swipleft} left={left} swipRight={swipRight}  />
    ...
    function undefined({swipleft, left, swipRight}) {
      return (<><span className='text-xl cursor-pointer absolute z-30 top-1/2 bg-white/90 rounded-full ml-2' onClick={swipleft}>{left}</span>
