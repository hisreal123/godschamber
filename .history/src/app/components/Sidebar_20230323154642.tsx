...
export default function Sidebar() {
  ...
  return (
    <div
      className="wrapper md:hidden transition-all z-[100px]">
      <div

        className={Open ? " transition-all h-screen bg-slate-400 w-4/5 absolute top-0  right-0 shadow-lg z-[500]" : 'hidden '}>
