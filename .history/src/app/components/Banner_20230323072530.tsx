  ...
  return (
    ...
    <div className="text text-white text-center ">
            ...
            <div className="btns flex flex-col">
                <ClickButton icon={location} title='Find a location' href="/" style=" flex  items-center justify-center space-x-5 rounded-full bg-red-600 text-white py-2 px-2 text-center md:px-4" />
