            ...
            <section className='py-16 px-5'>
                <div className='flex flex-col items-center justify-center relative '>
                    ...
                    <form method="post" className='relative'>
                        <input type="email" placeholder=' YOUR EMAIL *' className=' relative w-full  mb-5  text-sm rounded-3xl px-4 py-2 hover:first-letter:border-red-300 border-2 outline-none' />
